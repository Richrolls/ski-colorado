...
class MyAuthenticator(Authenticator): # Handles Login. Inheriting extra functionality Autheticator from jwtdown
    ...
    def get_hashed_password(self, account: AccountOutWithHashedPassword): #this is being handled internally
        # Return the encrypted password value from your
        # account object
        return account.hashed_password

    def get_account_data_for_cookie(self, account: AccountOut): #this is what we are giving to frontend
